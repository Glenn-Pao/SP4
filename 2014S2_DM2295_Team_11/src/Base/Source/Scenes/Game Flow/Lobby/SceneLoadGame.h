...
class CSceneLoadGame : public Scene
{
	enum GEOMETRY_TYPE
	{
		...
		GEO_DATA1_BUTTON_LOCKED,

		GEO_DATA2_BUTTON_UP,
		GEO_DATA2_BUTTON_DOWN,
		GEO_DATA2_BUTTON_LOCKED,

		GEO_DATA3_BUTTON_UP,
		GEO_DATA3_BUTTON_DOWN,
		GEO_DATA3_BUTTON_LOCKED,

		GEO_DATA4_BUTTON_UP,
		GEO_DATA4_BUTTON_DOWN,
		GEO_DATA4_BUTTON_LOCKED,

		GEO_DATA5_BUTTON_UP,
		GEO_DATA5_BUTTON_DOWN,
		GEO_DATA5_BUTTON_LOCKED,
		...
		// Delete
		GEO_DELETE_BUTTON_UP,
		GEO_DELETE_BUTTON_DOWN,
		GEO_DELETE_BUTTON_LOCKED,
