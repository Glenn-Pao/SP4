...
CSceneLose::CSceneLose(const int m_window_width, const int m_window_height)
{
...
void  CSceneLose::Init(int level)
{
	// Init the base scene
...
void   CSceneLose::Update(double dt)
{
	/*
