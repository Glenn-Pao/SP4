...
CSceneTutorialGame4::CSceneTutorialGame4(const int m_window_width, const int m_window_height)
	: m_cMinimap(NULL)
	, m_cMap(NULL)
	, tileOffset_x(0)
	, tileOffset_y(0)
...
CSceneTutorialGame4::~CSceneTutorialGame4()
{
	//for (int i = 0; i<10; i++)
	//{
...
void CSceneTutorialGame4::Init(int level)
{
	// Init the base scene
...
void CSceneTutorialGame4::PreInit()
{
...
********************************************************************************/
void CSceneTutorialGame4::InitMeshes()
{
	// Create the meshes
...
void CSceneTutorialGame4::Update(double dt)
{
...
********************************************************************************/
void CSceneTutorialGame4::UpdateCameraStatus(const unsigned char key, const bool status)
{
...
********************************************************************************/
void CSceneTutorialGame4::UpdateWeaponStatus(const unsigned char key)
{
	if (key == WA_FIRE)
	{
...
Render this scene
********************************************************************************/
void CSceneTutorialGame4::Render()
{
...
********************************************************************************/
void CSceneTutorialGame4::RenderTileMap()
{
	int m = 0;
	int j = 0;
...
********************************************************************************/
void CSceneTutorialGame4::RenderHero()
{
...
********************************************************************************/
void CSceneTutorialGame4::RenderAIs()
{
	// Render the enemy
	for (int i = 0; i < theEnemies.size(); i++)
	{
...
********************************************************************************/
void CSceneTutorialGame4::RenderRearTileMap()
{
	if (m_cRearMap)
	{
...
********************************************************************************/
void CSceneTutorialGame4::RenderGoodies()
{
	// Render the goodies
	for (int i = 0; i<10; i++)
	{
...
void CSceneTutorialGame4::RenderWaypoints()
{
...
// Read and store data
void CSceneTutorialGame4::ReadData(CGameInfo* Data)
{
	if (Data->ifNew == false)
	{
...
void CSceneTutorialGame4::StoreData(CGameInfo* Data)
{
...
void CSceneTutorialGame4::SetHeroOffset()
{
	// X
