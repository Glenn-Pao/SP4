...
public:
	enum GEOMETRY_TYPE
	{
		...
		// Game 1
		GEO_INSTRUCTION_HEADER,
		GEO_INSTRUCTION_MOVE_AROUND,
		GEO_INSTRUCTION_TIMER,
		GEO_INSTRUCTION_EXIT,
		GEO_INSTRUCTION_BLOCKER,
		GEO_INSTRUCTION_CONDITION,

		//Game3
		GEO_INSTRUCTION_LIVES,
		GEO_INSTRUCTION_MOVE,
		GEO_INSTRUCTION_QN_TRIGGER,
		GEO_INSTRUCTION_ANS_TRIGGER,
		GEO_INSTRUCTION_CHNGEANS,
		GEO_INSTRUCTION_ANS_QN,
		...
		GEO_BACKFADEON,
		GEO_WARNING,
		GEO_INSTRUCTION1_GAME2,
		GEO_INSTRUCTION2_GAME2,
		GEO_INSTRUCTION3_GAME2,
