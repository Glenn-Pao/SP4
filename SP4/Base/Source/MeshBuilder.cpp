...
*/
/******************************************************************************/
Mesh* MeshBuilder::GenerateRay(const std::string &meshName, float length)
{
	Vertex v;
...
/*!
\brief
Generate a part of 2D sprite sheet
Then generate the VBO/IBO and store them in Mesh object

\param meshName - name of mesh
\param width - width of quad
\param height - height of quad
\param numRow - number of row in the spriteSheet
\param numCol - number of column in the spriteSheet
\param posNumRow - position number of row in the spriteSheet
\param posNumCol - position number of column in the spriteSheet

\return Pointer to mesh storing VBO/IBO of quad
*/
/******************************************************************************/
Mesh* MeshBuilder::GeneratePartOfSpriteSheet2D(const std::string &meshName, int width, int height, unsigned numRow, unsigned numCol, int posNumRow, int posNumCol)
{
	Vertex v;
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
